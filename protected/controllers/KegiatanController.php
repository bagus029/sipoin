...
class KegiatanController extends Controller
{
	...
	public function actionKemahasiswaan()
	{
		...
		$model->dbCriteria->condition = 'idjeniskegiatan=:idjeniskegiatan';
        $model->dbCriteria->params = array(':idjeniskegiatan' => $kode);

		if(isset($_GET['Kegiatan']))
			$model->attributes=$_GET['Kegiatan'];

		$this->render('kemahasiswaan',array(
			'model'=>$model,
		));
	}

	public function actionInternasional()
	{
		...
		$this->render('internasional',array(
			'model'=>$model,
		));
	}
	/**
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Kegiatan']))
		{
			...
			if($model->save())
				$this->redirect(array('view','id'=>$model->idkegiatan));
		}
